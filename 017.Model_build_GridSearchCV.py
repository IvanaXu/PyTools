...
data_train, data_test, target_train, target_test = train_test_split(x, y, test_size=0.1, random_state=42)
...
print(model.score(data_train, target_train), model.score(data_test, target_test))
